...
`composeApp/` contains the shared Kotlin Multiplatform and Compose Multiplatform code. `androidApp/` packages the Android flavors, while `iosApp/` contains the Xcode project and native iOS entry point.
