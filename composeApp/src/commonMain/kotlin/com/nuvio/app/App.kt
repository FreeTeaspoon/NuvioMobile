                ...
                if (!localSourceUrl.isNullOrBlank()) {
                    val launchId = PlayerLaunchStore.put(
                        PlayerLaunch(
                            ...
                            sourceFilename = downloadedItem.fileName,
                            sourceVideoSize = downloadedItem.totalBytes,
                            logo = logo,
                            poster = poster,
                                ...
                                CompositionLocalProvider(
                                    ...
                                    AppTabHost(
                                        modifier = Modifier
                                            ...
                                            .then(if (!isTabletLayout && !useNativeBottomTabs) Modifier.layerBackdrop(navigationBackdrop) else Modifier),
                        ...
                        onOpenDownload = { item ->
                            ...
                            val launchId = PlayerLaunchStore.put(
                                PlayerLaunch(
                                    ...
                                    sourceVideoSize = item.totalBytes,
                                    logo = item.logo,
                                    poster = item.poster,
                                    background = item.background,
                                    seasonNumber = item.seasonNumber,
