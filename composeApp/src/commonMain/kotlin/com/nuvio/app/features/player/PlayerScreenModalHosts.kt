...
internal fun PlayerScreenModalHosts(
    ...
    showVideoZoomModal: Boolean,
    videoZoomState: PlayerVideoZoomState,
    onVideoZoomStateChanged: (PlayerVideoZoomState) -> Unit,
    onVideoZoomSetAsDefault: () -> Unit,
    onVideoZoomReset: () -> Unit,
    onVideoZoomModalDismissed: () -> Unit,
    ...
    VideoZoomModal(
        ...
        onStateChanged = onVideoZoomStateChanged,
        onSetDefault = onVideoZoomSetAsDefault,
        onReset = onVideoZoomReset,
        onDismiss = onVideoZoomModalDismissed,
    )
