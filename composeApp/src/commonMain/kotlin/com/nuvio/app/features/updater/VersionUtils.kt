...
internal data class SemanticVersion(
    ...
    override fun compareTo(other: SemanticVersion): Int {
        ...
        compareValues(forkRevision, other.forkRevision).takeIf { it != 0 }?.let { return it }
...
internal object VersionUtils {
    ...
    fun parse(raw: String?): SemanticVersion? {
        ...
        return SemanticVersion(
            ...
            forkRevision = match.groupValues[4].takeIf(String::isNotEmpty)?.toLongOrNull() ?: 0,
            prerelease = match.groupValues[5]
