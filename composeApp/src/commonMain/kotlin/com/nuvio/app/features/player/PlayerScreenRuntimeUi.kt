...
private fun PlayerScreenRuntime.RenderPlayerControls(displayedPositionMs: Long, isEpisode: Boolean) {
    ...
    AnimatedVisibility(
        ...
        PlayerControlsShell(
            ...
            onScrubActiveChanged = { isScrubbingTimeline = it },
            horizontalSafePadding = horizontalSafePadding,
            modifier = Modifier.fillMaxSize(),
        )
    }
...
private fun PlayerScreenRuntime.RenderPlayerModals(displayedPositionMs: Long) {
    PlayerScreenModalHosts(
        ...
        showVideoZoomModal = showVideoZoomModal,
        videoZoomState = videoZoomState,
        onVideoZoomStateChanged = ::applyVideoZoomState,
        onVideoZoomSetAsDefault = ::setVideoZoomAsDefault,
        onVideoZoomReset = ::resetVideoZoom,
        onVideoZoomModalDismissed = { showVideoZoomModal = false },
