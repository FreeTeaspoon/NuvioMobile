...
internal class PlayerScreenRuntime(
    ...
    var showSpeedModal by mutableStateOf(false)
    var showVideoZoomModal by mutableStateOf(false)
    ...
    val videoZoomContentKey: String?
        get() = rememberedVideoZoomContentKey(parentMetaType, parentMetaId)

    val videoZoomState: PlayerVideoZoomState
        get() = PlayerVideoZoomState(zoom = videoZoom).normalized()
}
