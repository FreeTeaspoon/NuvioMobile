...
internal actual object PlayerSettingsStorage {
    ...
    private val syncKeys = listOf(
        ...
        iosSaturationKey,
        iosGammaKey,
        rememberedAudioSelectionsKey,
        rememberedSubtitleSelectionsKey,
        rememberedVideoZoomsKey,
    )
    ...
    actual fun loadRememberedAudioSelections(): String? = loadString(rememberedAudioSelectionsKey)
    actual fun saveRememberedAudioSelections(json: String) = saveString(rememberedAudioSelectionsKey, json)
    actual fun loadRememberedSubtitleSelections(): String? = loadString(rememberedSubtitleSelectionsKey)
    actual fun saveRememberedSubtitleSelections(json: String) = saveString(rememberedSubtitleSelectionsKey, json)
    actual fun loadRememberedVideoZooms(): String? = loadString(rememberedVideoZoomsKey)
    actual fun saveRememberedVideoZooms(json: String) = saveString(rememberedVideoZoomsKey, json)
    ...
    actual fun exportToSyncPayload(): JsonObject = buildJsonObject {
        ...
        loadRememberedAudioSelections()?.let { put(rememberedAudioSelectionsKey, encodeSyncString(it)) }
        loadRememberedSubtitleSelections()?.let { put(rememberedSubtitleSelectionsKey, encodeSyncString(it)) }
        loadRememberedVideoZooms()?.let { put(rememberedVideoZoomsKey, encodeSyncString(it)) }
    }
    ...
    actual fun replaceFromSyncPayload(payload: JsonObject) {
        ...
        payload.decodeSyncString(rememberedAudioSelectionsKey)?.let(::saveRememberedAudioSelections)
        payload.decodeSyncString(rememberedSubtitleSelectionsKey)?.let(::saveRememberedSubtitleSelections)
        payload.decodeSyncString(rememberedVideoZoomsKey)?.let(::saveRememberedVideoZooms)
    }
}
